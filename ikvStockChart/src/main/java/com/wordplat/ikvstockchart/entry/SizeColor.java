...
public class SizeColor {
    ...
    private float highlightSize = 3f; // 高亮线条大小
    private int highlightColor = 0xff7294b6; // 高亮线条颜色 0xff1c232e

    private float markerBorderSize = 2f; // MarkerView 边框大小
    private int markerBorderColor = 0xff7294b6; // MarkerView 边框颜色
    public static float markerTextSize = 21; // MarkerView 字符大小
    ...
    public static float candleExtremumLabelSize = 21; // 蜡烛图极值字符大小
    private int candleExtremumLableColor = 0xff282b34; // 蜡烛图极值字符颜色

    private float shadowSize = 4f; // 影线大小
    private int increasingColor = 0xfffe0000; // 上涨颜色
    private int decreasingColor = 0xff009901; // 下跌颜色
    private int neutralColor = 0xfffe0000; // 不涨不跌颜色

    private int portraitDefaultVisibleCount = 60; // 竖屏状态下的默认缩放倍数下显示多少个蜡烛图。注：横屏时会自动根据视图宽高变化比例计算，不需要手工设置
    ...
    private int ma5Color = 0xffe921ec; // MA5 平均线颜色
    private int ma10Color = 0xffd1a213; // MA10 平均线颜色
    private int ma20Color = 0xff15a4ac; // MA20 平均线颜色
    ...
    private int macdHighlightTextColor = 0xffe921ec; // 高亮的 MACD 字符颜色，此值与 macdTextColor 不同
    private int deaLineColor = 0xff15a4ac; // DEA 线条颜色
    private int diffLineColor = 0xffd1a213; // DIFF 线条颜色
    ...
    //闪电图
    public static float rectHeight;//滑块高度
    public static float textSize;//文字大小
    public static float radiusSize;//圆心大小
