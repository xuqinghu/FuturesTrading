...
public class KLineRender extends AbstractRender {
    ...
    private KLineMoveHandler kLineMoveHandler;
    ...
    public void setKLineMoveHandler(KLineMoveHandler kLineMoveHandler){
        this.kLineMoveHandler = kLineMoveHandler;
    }
    ...
    private void computeVisibleIndex() {
        ...
        kLineMoveHandler.onMove(maxVisibleIndex-1);
