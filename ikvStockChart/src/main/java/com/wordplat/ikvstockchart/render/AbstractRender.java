...
public abstract class AbstractRender {
    ...
    private int decimalPlaces;//小数位
    private String smallestFluctuation;//最小波动
    ...
    private float[] touchValues = new float[9]; // 存储缩放和平移信息
     ...
     * @param y
     */
    public abstract void zoomDefault(float x, float y);
     ...
     *设置最小波动
     */
    public void setSmallestFluctuation(String smallestFluctuation){
        this.smallestFluctuation = smallestFluctuation;
    }

    public String getSmallestFluctuation(){
        return smallestFluctuation;
    }
    ...
    public void scroll(float dx) {
        ...
        if (touchValues[Matrix.MTRANS_X] > minScrollOffset) {
            // TODO: 2018/8/28 不知道原因 本来是 touchValues[Matrix.MTRANS_X] = minScrollOffset
            touchValues[Matrix.MTRANS_X] = 1;
        }
